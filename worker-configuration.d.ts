/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8fa2d625aa9f066c71b7c4b68bac6c64)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_SITE_URL" | "EMAILJS_PRIVATE_KEY" | "PUBLIC_POSTHOG_HOST" | "PUBLIC_GA_MEASUREMENT_ID" | "PUBLIC_EMAILJS_SERVICE_ID" | "PUBLIC_EMAILJS_PUBLIC_KEY" | "PUBLIC_EMAILJS_TEMPLATE_ID" | "PUBLIC_POSTHOG_PROJECT_TOKEN">> {}
}
...
type AssistantMessage = {
  role: "assistant";
  content?: string | null | AssistantMessageContentPart[];
  refusal?: string | null;
  name?: string;
  audio?: {
    id: string;
